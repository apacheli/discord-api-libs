...
- [Discore](https://github.com/Francessco121/Discore) - A .NET Standard interface for the Discord API designed for creating bots.
...
- [Remora.Discord](https://github.com/Nihlus/Remora.Discord) - A data-oriented C# Discord library, focused on high-performance concurrency and robust design.
...
- [alchemy](https://github.com/cronokirby/alchemy) - A discord library for Elixir
...
- [crux](https://github.com/SpaceEEC/crux) - Repository creating the umbrella documentation for all crux libraries
...
- [jda-ktx](https://github.com/MinnDevelopment/jda-ktx)[^wrapper] - Collection of useful Kotlin extensions for JDA
...
- [discordia-slash](https://github.com/GitSparTV/discordia-slash)[^interactions][^wrapper] - Discordia application commands extension
...
- [DiscPyth](https://github.com/DiscPyth/DiscPyth) - DiscPyth is an unofficial wrapper in Python for the official Discord API.
...
- [disnake](https://github.com/DisnakeDev/disnake)[^fork] - An API wrapper for Discord written in Python.
...
- [enhanced-discord.py](https://github.com/iDevision/enhanced-discord.py)[^fork] **(archived)** - An API wrapper for Discord written in Python.
- [flask-discord-interactions](https://github.com/Breq16/flask-discord-interactions)[^interactions] - A Flask extension to enable declarative definitions for Discord slash commands.
...
- [accord](https://github.com/passcod/accord) - Discord API client to power Discord API clients via the power of love, friendship, and HTTP 💖
...
- [Deno-Discord-Slash-Commands](https://github.com/Redstoneguy129/Deno-Discord-Slash-Commands)[^fork][^interactions] - Deno Slash Commands for Discord 
